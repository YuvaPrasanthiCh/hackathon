                ...
                <div className='producer_navbar_container'>
                    <div className='producer_navbar_left'>
                        <a href='/producer-dashboard'>
                            <span className='producer_nav_span_1' style={{ color:"#087f5b"}}> <b>FreeLance</b></span>
                            <span className='producer_nav_span_2' style={{ color:"#087f5b"}}>Sync</span>
                        </a>
                    </div>
                        ...
                        >
                            {
                                ...
                                (
                                    incomingConnectionRequests.map((incomingConnectionRequest, index) => {
                                        return (
                                            <div 
                                            key={incomingConnectionRequest._id}
                                                className='container'
                                                style={{
                                                    width: '100%',
                                                    minHeight: '4rem',
